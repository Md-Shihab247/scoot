...
const Banner = () => {
  return (
   <section className={` bg-[url(../images/mobile-banner.png)] md:bg-[url(../images/tablet-banner.png)]  lg:bg-[url(../images/banner.jpg)] w-screen md:w-full lg:w-full bg-no-repeat bg-center h-162.5`}>
       <div className=" container flex flex-col items-center pt-[115px] pb-[180px] md:flex md:flex-col md:items-center lg:items-start lg:py-[152px] ">
          ...
          <div className='flex items-center lg:items-start flex-col lg:flex-none text-center lg:text-start lg:ml-[90px] mt-[22px] lg:mt-10'>

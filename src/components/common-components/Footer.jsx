...
const Footer = () => {
  return (
   <>
      <footer className=" bg-dark-navy bg-[url('../images/footer-circle.png')] py-[88px] lg:py-25.5 relative  bg-no-repeat bg-bottom-right">
      ...
      <div className=" pt-16 pb-[88px] md:py-8 bg-[#333A44]">
         <div className=" lg:container md:px-10 lg:px-0 md:mx-auto flex flex-col md:flex-row items-center justify-between">
